...
// @match        https://cok.siberianhealth.com/kz-ru/*
// @match        https://ru.siberianhealth.com/ru/*
// @match        https://kz.siberianhealth.com/ru/*
// @match        https://kz.siberianwellness.com/kz-ru/cart/
// @match        https://ru.siberianhealth.com/ru/store/header/index/list/*
// @match        https://kz.siberianhealth.com/ru/store/header/index/list/*
// @match        https://ru.siberianhealth.com/ru/store/header/new/
// @match        https://kz.siberianhealth.com/ru/store/header/new/
// @match        https://ru.siberianhealth.com/ru/store/header/new/create/
// @match        https://kz.siberianhealth.com/ru/store/header/new/create/
// @match        https://ru.siberianhealth.com/ru/store/header/new/edit/
// @match        https://kz.siberianhealth.com/ru/store/header/new/edit/
...
var sheContent = {
  ...
  scripts: {
    pantryCatalogUpdater: {
      init() {
        l('SHE: panrtyCatalogUpdater initializing...');
    ...
    wellnessCartProductSearch: {
  	...
  	editButtonForNewCreate: {
  		init() {
  			...
  			var factura_Td = document.querySelectorAll('#delBox tr')[1].children[0];
    ...
    autoFacture: {
      ...
      async _handleOrderTextareaEvent() {
        ...
        this.query_order = {
          positions: [],
          factureId: document.querySelectorAll('#delBox tr')[1].children[0].innerText
        };
