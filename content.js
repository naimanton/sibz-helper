...
var sheContent = {
  ...
  chooseScript(pathname) {
    if (pathname.includes('/ru/') && document.body.innerText.includes('Страница доступна только авторизованным пользователям. Пожалуйста, введите ваш логин и пароль на странице входа')) {
      document.location.pathname = '/ru/login/';
      return;
    }
